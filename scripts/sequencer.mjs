...
setInterval(() => { eventEmitter.emit('sequence'); }, 10000);

// eventEmitter.on('chainUpdate', callChainUpdate);
// setInterval(() => { eventEmitter.emit('chainUpdate'); }, 350000);
